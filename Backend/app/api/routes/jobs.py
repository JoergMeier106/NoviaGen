...
from ..responses.jobs import (
    ...
    create_chain_job_response as _create_chain_job_response,
...
from ..payloads.media import is_still_media as _is_still_media
from .context import (
    catalog as _catalog,
...
@api.post("/api/jobs/chain")
def create_chain_job() -> Response:
    return _create_chain_job_response(
        request_obj=request,
        catalog=_catalog(),
        db=_db(),
        worker=_worker(),
