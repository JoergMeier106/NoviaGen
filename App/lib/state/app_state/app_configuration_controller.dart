...
import 'app_generation_draft_persistence.dart';
import 'app_settings_persistence.dart';
import 'app_settings_persistence_scope.dart';


class AppConfigurationDependencies {
  const AppConfigurationDependencies({
  ...
  final AppSettingsPersistenceScope persistence;
...
class AppConfigurationController {
  AppConfigurationController(this.dependencies);

  final AppConfigurationDependencies dependencies;
  final AppSettingsPersistence _persistence = AppSettingsPersistence();
  final AppGenerationDraftPersistence _draftPersistence =
